...
Original file is located at
    https://colab.research.google.com/drive/1jyt0kt2UASp2uKu5AsKNAjzEXFef9lko
...
def create_scatter_plot():
  ...
  # Draw a scatter plot of x against y, using x markers.
  plt.plot(x,y,'x',markersize=5,alpha=.5)
  plt.show()
  return None
...
n= 1000 # Number of iterations you'd like to run the bisection method for.
for i in range(n):
  d = (a + b)/2
  if f(d) < 0:
    a = d
